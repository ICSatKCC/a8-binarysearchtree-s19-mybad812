...
public class Charizard extends Charmeleon implements FlyingType {
   ...
   public Charizard() {
      super("Charizard", "Charizard", 6, 1.7, 90.5, FLYING_TYPE, FLYING_TYPE,
             BASE_ATTACK_POWER, BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      //referenced by Kristine.       
      this.type2 = FLYING_TYPE;
   ...
   */
   public Charizard(String name) {
      super("Charizard", name, 6, 1.7, 90.5, FLYING_TYPE, FLYING_TYPE, 
             BASE_ATTACK_POWER, BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      //referenced by Kristine.
      this.type2 = FLYING_TYPE;
   ...
   * choosing attack type by fire or flying randomly
   * Choosing type of attack from attack arrays
   */
   protected void chooseSpecialAttack() {
      //chooseing to get fire or flying attack randomly
      Random randGen = new Random();
      int index;
